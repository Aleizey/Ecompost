<x-app-layout>
    <div class="h-screen flex flex-col bg-[#FFFFFF]">
        ...
        <!-- Main -->
        <main class="flex-grow flex flex-col text-[#4F4F4F] bg-[#FFFFFF] overflow-auto mt-5">
            <div class="w-full px-4 sm:px-6 lg:px-8 flex flex-wrap gap-6 justify-center">
                <!-- Primer formulario -->
                <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg w-full lg:w-[45%]">
