    ...
    <div class="h-screen  flex flex-col bg-[#FFFFFF]">
        ...
        <header class="h-[10vh] w-full flex items-center p-2 bg-white text-black">
            ...
            <div class="ml-8 flex items-center justify-center h-16 w-16">
                <img class="h-full w-full object-contain rounded-full" src="https://cdn.discordapp.com/attachments/1309702840175825049/1311400562150998046/logo.png?ex=674ab2b2&is=67496132&hm=33961d1eee5dcdfe20fef7709e77dab68619a4a95d58777e3cd2c4f65ed27781&" alt="web-img">
            </div>
        ...
        <!-- Main -->
        <main class="flex-grow flex justify-center items-center text-center text-[#4F4F4F] bg-[#FFFFFF] overflow-y-auto" style="height: calc(80vh - 60px);">
